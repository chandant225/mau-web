    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                @endif
                <form method="post" action="{{ route('admin.gallery.image.add_more.update',['album_slug' => $slug]) }}" enctype="multipart/form-data">
                    @csrf
                    <div class="card-body">
                        <div class="form-group">
                            <label for="exampleInputFile">Add the gallery images</label>
